...
class CreditTransfersRepository {
  ...
  Future<List<CreditTransferRequest>> fetch() async {
    ...
    final items = ((response.data as Map<String, dynamic>)['data'] as List).cast<Map<String, dynamic>>();
  ...
  Future<void> submit({required String position, required int academicYear, required String proofImagePath}) async {
