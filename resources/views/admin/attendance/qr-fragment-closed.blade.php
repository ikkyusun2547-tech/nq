...
<div class="flex flex-col items-center py-6">
    ...
    <p class="mb-1 text-base font-semibold text-gray-900 dark:text-slate-100">{{ __('กิจกรรมนี้ปิดรับเช็คชื่อแล้ว') }}</p>
    ...
    <p class="mt-3 max-w-[16rem] text-xs text-gray-400 dark:text-slate-500">{{ __('เปลี่ยนสถานะกิจกรรมเป็น "เปิดรับสมัคร" หรือ "กำลังดำเนินการ" เพื่อเปิดใช้ QR เช็คชื่ออีกครั้ง') }}</p>
</div>
