...
<div class="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 py-8 text-center brand-gradient">
    ...
    <a href="{{ route('admin.activities.index') }}" class="absolute left-4 top-4 text-sm text-white/70 hover:text-white">&larr; กลับ</a>
    ...
    <p class="relative mb-6 text-sm text-white/80">สแกน QR นี้เพื่อเช็กชื่อเข้าร่วมกิจกรรม</p>
    ...
    <p class="relative mt-4 text-xs text-white/70">QR จะเปลี่ยนรหัสอัตโนมัติทุก 15 วินาทีเพื่อความปลอดภัย</p>
</div>
@endsection
