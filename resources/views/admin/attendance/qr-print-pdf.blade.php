...
<body>
    ...
    <div class="warning">
        <strong>ใช้เฉพาะกรณีจำเป็นเท่านั้น</strong> — QR นี้ไม่หมุนรหัสเหมือนหน้าจอเช็กชื่อสด เพื่อให้พิมพ์ติดหน้างานได้ ดังนั้นการเช็กชื่อทุกครั้งที่ใช้ QR นี้จะถูก<strong>ติดธงรอเจ้าหน้าที่ตรวจสอบ</strong>เสมอ (ไม่อนุมัติอัตโนมัติ) แม้ตำแหน่ง GPS และเซลฟีจะถูกต้องก็ตาม
    </div>
