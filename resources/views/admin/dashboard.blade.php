...
<div class="mx-auto max-w-[90rem]">
    ...
    <div class="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-3 xl:grid-cols-6">
        @php
            $cards = [
                ...
                ['label' => __('เช็คชื่อเดือนนี้'), 'value' => $stats['checkins_this_month'], 'icon' => 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'tint' => 'text-sky-600 bg-sky-50 dark:text-sky-400 dark:bg-sky-500/10'],
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <x-section-card icon="M3 17l6-6 4 4 8-8M21 7v6h-6" :title="$academicYear !== '' ? __('แนวโน้มการเช็คชื่อรายเดือน') : __('แนวโน้มการเช็คชื่อ 6 เดือนล่าสุด')">
            <x-slot:action>
                <span class="text-xs text-slate-400 dark:text-slate-500">{{ $academicYearScopeLabel }}</span>
            </x-slot:action>
