...
>
    ...
    <div class="relative w-full max-w-xl">
        ...
        <form method="POST" action="{{ route('profile-setup.store') }}"
            class="space-y-7 rounded-3xl glass-card p-6 shadow-soft-lg sm:p-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-3.5 sm:grid-cols-3">
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-slate-600">คำนำหน้าชื่อ</label>
                        <select
                            name="title_prefix" required
                            class="w-full rounded-2xl border-slate-200 bg-slate-50/50 text-sm text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                        >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-2xl border-slate-200 bg-slate-50/50 pl-9 text-sm text-slate-700 placeholder:text-slate-400 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-600">รหัสนักศึกษา</label>
                    <div class="relative">
                        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-slate-600">ปีที่เข้าศึกษา (พ.ศ.)</label>
                        <div class="relative">
                            <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-600">คณะ</label>
                    <div class="relative">
                        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
                        ...
                        <select
                            ...
                            class="w-full rounded-2xl border-slate-200 bg-slate-50/50 pl-9 text-sm text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                        >
                ...
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-slate-600">สาขาวิชา</label>
                    <div class="relative">
                        <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3 text-slate-400">
                        ...
                        <select
                            ...
                            class="w-full rounded-2xl border-slate-200 bg-slate-50/50 pl-9 text-sm text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10 disabled:text-slate-400"
                        >
            ...
            <button
                type="submit"
                class="flex w-full items-center justify-center gap-2 rounded-2xl bg-brand-green-500 px-4 py-3.5 text-sm font-semibold text-brand-purple-950 shadow-soft transition-all duration-300 hover:-translate-y-0.5 hover:bg-brand-green-400 hover:shadow-lg active:scale-[0.99]"
            >
