                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        <div>
                            ...
                            <select
                                ...
                                class="w-full rounded-2xl border-2 border-slate-200 bg-white px-4 py-3.5 text-base text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                            >
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    class="w-full rounded-2xl border-2 border-slate-200 bg-white py-3.5 pl-12 pr-4 text-base text-slate-700 placeholder:text-slate-400 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full rounded-2xl border-2 border-slate-200 bg-white px-4 py-3.5 text-base text-slate-700 placeholder:text-slate-400 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full rounded-2xl border-2 border-slate-200 bg-white py-3.5 pl-12 pr-4 text-base tracking-wide text-slate-700 placeholder:text-slate-400 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-2.5">
                                <label class="flex cursor-pointer items-center justify-center rounded-2xl border-2 border-slate-200 bg-white px-2 py-3.5 text-base shadow-soft transition-all duration-200 has-[:checked]:border-brand-purple-500 has-[:checked]:bg-brand-purple-50 has-[:checked]:text-brand-purple-700 has-[:checked]:shadow-none has-[:focus-visible]:ring-4 has-[:focus-visible]:ring-brand-purple-500/10">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select
                                ...
                                class="w-full rounded-2xl border-2 border-slate-200 bg-white py-3.5 pl-12 pr-4 text-base text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10"
                            >
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select
                                ...
                                class="w-full rounded-2xl border-2 border-slate-200 bg-white py-3.5 pl-12 pr-4 text-base text-slate-700 shadow-soft transition-all duration-200 focus:border-brand-purple-500 focus:outline-none focus:ring-4 focus:ring-brand-purple-500/10 disabled:bg-slate-50 disabled:text-slate-400"
                            >
